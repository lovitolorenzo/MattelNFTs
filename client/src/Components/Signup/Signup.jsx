...
const Signup = (props) => {
	...
	const { registerSeller, sellerError, clearSellerErrors, isSellerAuthenticated } = useContext(sellerAuthContext);

	const { registerUser, error, clearErrors, isUserAuthenticated } = useContext(userAuthContext);
						...
						<div className={classes.form_container}>
							...
							<form className={classes.form}>
								...
								<div className={classes.btn}>
									{!isUserAuthenticated ? (
										<CustomButton onClick={onSubmitHandler} label="Create User" disabled={isUserAuthenticated} filled />
									) : null}
