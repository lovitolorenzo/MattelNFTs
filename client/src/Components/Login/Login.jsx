...
const Login = () => {
	...
	const { login, error, clearErrors, isUserAuthenticated } = useContext(userAuthContext);
				...
				<div className={classes.right_section}>
					...
					<form className={classes.form} onSubmit={onSubmitHandler}>
						...
						<div className={classes.btn}>
							{!isUserAuthenticated ? (
								<CustomButton onClick={onSubmitHandler} disabled={isUserAuthenticated} label="User Log In" filled />
							) : null}
