    ...
    PausableUpgradeable
{
    ...
    /// @notice Safe mint di un nuovo NFT con garanzia
    function safeMint(
        address to,
        string calldata uri,
        uint64 duration
    ...
    /// @notice Batch mint di nuovi NFT con garanzia
    ...
    /// @notice Total supply degli NFT creati
    function totalSupply() public view returns (uint256) {
        return _tokenCount;
    }

    /// @notice Funzione di pausa del contratto, accessibile solo agli admin
    function pause() external onlyRole(DEFAULT_ADMIN_ROLE) {
        _pause();
    }

    /// @notice Funzione di riattivazione del contratto, accessibile solo agli admin
